      ...
      <div className='d-flex justify-content-center align-items-center w-100 mt-5 bg-dark' style={{ height: "90vh" }}>
        <div className='bg-light p-5 rounded' style={{ width: "500px" }}>
          ...
          <form action="" className='mt-3' onSubmit={calculateInterest}>
            ...
            <TextField className='w-100' id="outlined-basic" label="&#8377;Principle Amount"
              variant="outlined"
              value={principle}
              name='principlevalue'
            ...
            <TextField className='w-100 mt-2' id="outlined-basic" label="Rate of interest (p.a)%"
              variant="outlined" 
              value={interest} 
              name='interestField'
              onChange={(e) =>validate(e) } />
            ...
            <TextField className='w-100 mt-2' id="outlined-basic" label="Year(Yr)"
              variant="outlined" 
              value={year}
              name='yearField'
              onChange={(e) =>validate(e) } />
